    ...
    <section className="min-h-screen bg-white  text-white px-6 lg:px-20 py-24">
      <div className="mx-auto  grid grid-cols-1 lg:grid-cols-3 gap-28 items-start">
        ...
        <div className="space-y-4 col-span-1">
          <p className="2xl:text-[16px] xl:text-[15px] font-[400] text-[#262626] ">
          ...
          <p className="italic font-instrument-serif 2xl:text-[20px] xl:text-[17px] font-[400] text-[#262626]">Clear design, shipped fast.</p>
        </div>
      </div>
    </section>
  );
