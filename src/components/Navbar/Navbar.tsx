const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 py-6">
      <div className=" xl:max-w-[1240px] 2xl:max-w-[1428px] mx-auto px-8 flex justify-between items-center">
        <a 
          href="/" 
  ...
  <div className="relative w-5 h-5 bg-[#C2FFCD] rounded-full animate-pulse-dot flex items-center justify-center">
    <div className="w-2 h-2 bg-[#46DC74] rounded-full animate-pulse-dot"></div>
          ...
          {/* Menu Button */}
          <button 
            className="flex items-center h-[48px] gap-2 pl-5 px-3 py-2 bg-white rounded-[25px] hover:border-gray-300 hover:bg-gray-100 transition-all duration-200"
            aria-label="Menu"
          >
